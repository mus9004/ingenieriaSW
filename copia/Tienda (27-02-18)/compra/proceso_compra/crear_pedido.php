...
for($i=0;$i<count($_SESSION["mi_carrito"]);$i++){
	...
	// descargable
	$descargable= $_SESSION["mi_carrito"][$i]["descargable"];
	...
	mysqli_query($conexion,"INSERT INTO pedidos (pedido,producto,cantidad,precio_producto,id_cliente,descargable,id_producto) VALUES('$pedido','$producto','$cantidad','$precio','$id_cliente','$descargable','$id_producto')");
...
unset($_SESSION['cantidad_de_productos']);
