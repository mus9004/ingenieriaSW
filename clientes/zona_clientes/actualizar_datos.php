...
//------------------------------------------------------//
	...
	mysqli_query($conexion,"UPDATE clientes SET nombre='$nombre', apellidos='$apellidos',email='$email', direccion='$direccion',cp='$cp', provincia='$provincia', telefono='$telefono', password='$password' WHERE id_cliente='$_POST[id_cliente]'");
