...
if(isset($_GET['id_subcategoria'])){
	...
	$registros20=mysqli_query($conexion,"select nombre from subcategorias where 	id_subcategoria='$_GET[id_subcategoria]'"); 
	$fila20=mysqli_fetch_array($registros20);
...
<p class="fuente"><span style="color:red">Inicio</span><span style="color:#FFF"> -></span><span style="color:#F90"><?php echo utf8_encode($fila2['categoria']); ?></span><?php if(isset($_GET['id_subcategoria'])) {?><span style="color:#FFF">-></span><span style="color:#F9F"><?php echo utf8_encode($fila20['nombre']); ?></span><?php } ?><span style="color:#FFF">-></span><span style=" color:#090"><?php echo utf8_encode($fila3['nombre']); ?></span></p>
...
<p style="font-size:30px; font-family:'Ceviche One', cursive;">
<?php 
