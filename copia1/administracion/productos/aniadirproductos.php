...
if(isset($_SESSION['administrador']) && isset($_POST['nombre'])){
	...
	// checbox_archivo
	if(isset($_POST["checbox_archivo"])){ 
	// checbox_archivo
		mysqli_query($conexion,"insert into productos 		(nombre,precio,descripcion,id_categoria,id_subcategoria,cantidad,descargable) values 	('$nombre','$precio','$descripcion','$categoria','$id_subcategoria','$cantidad',1)");
	}else{
		mysqli_query($conexion,"insert into productos 		(nombre,precio,descripcion,id_categoria,id_subcategoria,cantidad) values 	('$nombre','$precio','$descripcion','$categoria','$id_subcategoria','$cantidad')");	
	}
