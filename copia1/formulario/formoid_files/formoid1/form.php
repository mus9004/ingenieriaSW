...
define('EMAIL_FOR_REPORTS', 'clienteantoniorodriguez@gmail.com');
...
<!-- Start Formoid form-->
<link rel="stylesheet" href="<?php echo dirname($form_path); ?>/formoid-metro-cyan.css" type="text/css" />
<form enctype="multipart/form-data" class="formoid-metro-cyan" style="background-color:#ffffff;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#66666;max-width:600px;min-width:150px" method="post"><div class="title"><h2>Formulario de Contacto</h2></div>
	...
	<div class="element-name<?php frmd_add_class("name"); ?>"><label class="title">Nombre y Apellidos<span class="required">*</span></label><span class="nameFirst"><input  type="text" size="8" name="name[first]" required="required"/><label class="subtitle">Nombre</label></span><span class="nameLast"><input  type="text" size="14" name="name[last]" required="required"/><label class="subtitle">Apellidos</label></span></div>
	...
	<div class="element-url<?php frmd_add_class("url"); ?>"><label class="title">Website</label><input class="large" type="url" name="url" value="http://" /></div>
