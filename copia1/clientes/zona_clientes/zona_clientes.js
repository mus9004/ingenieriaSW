...
function actualizar_datos(){
	...
	$.ajax({
			...
			data:{"nombre":nombre,"apellidos":apellidos,"email":email,"direccion":direccion,"provincia":provincia,"cp":cp,"telefono":telefono,"password":password,"id_cliente":id_cliente},
